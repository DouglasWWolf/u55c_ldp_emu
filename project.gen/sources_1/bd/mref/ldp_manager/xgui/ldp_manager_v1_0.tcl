...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FRAME_DROP_ERR_BIT" -parent ${Page_0}
...
proc update_PARAM_VALUE.FRAME_DROP_ERR_BIT { PARAM_VALUE.FRAME_DROP_ERR_BIT } {
	# Procedure called to update FRAME_DROP_ERR_BIT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FRAME_DROP_ERR_BIT { PARAM_VALUE.FRAME_DROP_ERR_BIT } {
	# Procedure called to validate FRAME_DROP_ERR_BIT
	return true
}
...
proc update_MODELPARAM_VALUE.FRAME_DROP_ERR_BIT { MODELPARAM_VALUE.FRAME_DROP_ERR_BIT PARAM_VALUE.FRAME_DROP_ERR_BIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FRAME_DROP_ERR_BIT}] ${MODELPARAM_VALUE.FRAME_DROP_ERR_BIT}
}
